...
import { Pressable, type PressableProps, ScrollView, SectionList, Text, View, type ViewStyle, VirtualizedList } from 'react-native';
...
const Actionsheet = React.forwardRef<React.ComponentRef<typeof UIActionsheet>, IActionsheetProps>(function Actionsheet({ className, isOpen, closeOnOverlayClick = true, ...props }, ref) {
