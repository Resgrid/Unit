  ...
  const renderContent = () => {
    ...
    return (
      <FlatList<RoutePlanResultData>
        ...
        ListHeaderComponent={
          activeInstance ? (
            <Pressable onPress={() => router.push(`/routes/active?planId=${activeInstance.RoutePlanId}`)}>
              <Box className="mb-4 rounded-xl border-2 border-green-500 bg-green-50 p-4 dark:bg-green-900/20">
  ...
  return (
    <View className="size-full flex-1 bg-gray-50 dark:bg-gray-900">
      <Box className="flex-1 px-4 pt-4">
        ...
        <Fab size="lg" onPress={() => router.push('/routes/start')} testID="new-route-fab">
