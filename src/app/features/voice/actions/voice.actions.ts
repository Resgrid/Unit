...
export enum VoiceActionTypes {
  ...
  SHOW_PTT_PLUGIN = '[VOICE] SHOW_PTT_PLUGIN',
  SHOW_SELECT_AUDIO_MODAL = '[VOICE] SHOW_SELECT_AUDIO_MODAL',
  GET_AUDIOSTREAMS = '[VOICE] GET_AUDIOSTREAMS',
  GET_AUDIOSTREAMS_SUCCESS = '[VOICE] GET_AUDIOSTREAMS_SUCCESS',
  GET_AUDIOSTREAMS_FAIL = '[VOICE] GET_AUDIOSTREAMS_FAIL',
  SET_ACTIVE_AUDIOSTREAM = '[VOICE] SET_ACTIVE_AUDIOSTREAM',
}
...
export class ShowPTTPlugin implements Action {
  readonly type = VoiceActionTypes.SHOW_PTT_PLUGIN;
  constructor() {}
}


export class GetAudioStreams implements Action {
  readonly type = VoiceActionTypes.GET_AUDIOSTREAMS;
  constructor() {}
}

export class GetAudioStreamsSuccess implements Action {
  readonly type = VoiceActionTypes.GET_AUDIOSTREAMS_SUCCESS;
  constructor(public payload: DepartmentAudioResultStreamData[]) {}
}

export class GetAudioStreamsFail implements Action {
  readonly type = VoiceActionTypes.GET_AUDIOSTREAMS_FAIL;
  constructor() {}
}

export class ShowAudioStreamModal implements Action {
  readonly type = VoiceActionTypes.SHOW_SELECT_AUDIO_MODAL;
  constructor() {}
}

export class SetActiveAudioStream implements Action {
  readonly type = VoiceActionTypes.SET_ACTIVE_AUDIOSTREAM;
  constructor(public payload: DepartmentAudioResultStreamData) {}
}
...
export type VoiceActionsUnion =
  ...
  | GetAudioStreams
  | GetAudioStreamsSuccess
  | GetAudioStreamsFail
  | ShowAudioStreamModal
