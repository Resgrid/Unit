...
export function reducer(
  ...
  switch (action.type) {
    ...
    case VoiceActionTypes.GET_AUDIOSTREAMS_SUCCESS:
      let steams: DepartmentAudioResultStreamData[] = new Array();
      steams.push({
        Id: '',
        Name: 'Off',
        Url: '',
    ...
    case VoiceActionTypes.SET_ACTIVE_AUDIOSTREAM:
      return {
        ...state,
...
export const getActiveStream = (state: VoiceState) => state.activeAudioStream;
