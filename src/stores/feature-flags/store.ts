...
export const FeatureFlagKeys = {
  ...
  RecordsFieldUnit: 'Records.Field.Unit',
...
export const useIsRecordsFieldEnabled = () => {
  ...
  const field = useFeatureFlag(FeatureFlagKeys.RecordsFieldUnit);
  return system && field;
};

export const useRecordsFieldStatus = (): FeatureFlagStatus => {
  const parent = useFeatureFlagStatus(FeatureFlagKeys.RecordsSystem);
  const child = useFeatureFlagStatus(FeatureFlagKeys.RecordsFieldUnit);
